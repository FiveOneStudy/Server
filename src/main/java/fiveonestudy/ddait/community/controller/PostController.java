...
public class PostController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<PostCreateResponse>> createPost(@AuthenticationPrincipal CustomUserDetails userDetails,
                                                                      @RequestBody @Valid CreatePostRequest request
    ) {

        PostCreateResponse response = postService.create(                userDetails.getUser(),
                request.title(),
                request.content()
        );
